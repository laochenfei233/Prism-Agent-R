<script lang="ts">
  ...
  let loadingPaths = new SvelteSet<string>();
...
<div class="files-panel">
  {#if indexStatus}
    <div class="index-bar" class:disabled={!indexStatus.enabled}>
      <div class="index-info">
        <span
          class="index-dot"
          class:on={indexStatus.enabled && !indexStatus.in_progress}
          class:busy={indexStatus.in_progress}
        ></span>
  ...
  <div class="search-bar">
    ...
    <input type="text" placeholder="过滤文件..." bind:value={filterText} />
  </div>
