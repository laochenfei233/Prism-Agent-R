<script lang="ts">
	...
	let svg = $derived(`<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" fill="none" viewBox="9 9 102 102" >
      <g clip-path="url(#google-i-googlelight__a)">
        <mask
          id="google-i-googlelight__b"
          width="86"
          height="86"
          x="17"
          y="17"
        ...
        <g mask="url(#google-i-googlelight__b)">
          <g filter="url(#google-i-googlelight__c)">
            <path
              fill="url(#google-i-googlelight__d)"
          ...
          <g filter="url(#google-i-googlelight__e)">
            <path
              fill="url(#google-i-googlelight__f)"
          ...
          <g filter="url(#google-i-googlelight__g)">
            <path
              fill="url(#google-i-googlelight__h)"
          ...
          <g filter="url(#google-i-googlelight__i)">
            <path
              fill="url(#google-i-googlelight__j)"
          ...
          <g filter="url(#google-i-googlelight__k)">
            <path
              fill="#3086FF"
          ...
          <g filter="url(#google-i-googlelight__l)">
            <path
              fill="url(#google-i-googlelight__m)"
          ...
          <g filter="url(#google-i-googlelight__n)">
            <path
              fill="url(#google-i-googlelight__o)"
          ...
          <g filter="url(#google-i-googlelight__p)">
            <path
              fill="url(#google-i-googlelight__q)"
          ...
          <g filter="url(#google-i-googlelight__r)" opacity="0.5">
            <path
              fill="url(#google-i-googlelight__s)"
      ...
      <defs>
        ...
        <clipPath id="google-i-googlelight__a">
